...
for ii = 1:TrainingDuration
    
     [KeyIsDown, v, keyCode]=KbCheck;
...
%     ii = ii+1;
    ...
    while (GetSecs - StartExp) < TrainingDuration
...
%% Data storage
% EquationMat = strings(1,ii); 
% AnswerMat = zeros(1,ii);
% ReactionTimeMat = zeros(1,ii);
% PartRespMat = zeros(1,ii);
