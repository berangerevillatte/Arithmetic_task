...
AnswerMat = zeros(1,TaskDuration); %create a column vector of zeros (at least the min number of trials)
...
DataCollect = [PartRespMat, AnswerMat, ReactionTimeMat];
FileName = [SubjectCode,'_', datestr(now,'dd-mm-yyyy')]; 
xlswrite(FileName, DataCollect);